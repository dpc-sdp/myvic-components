    ...
    {
      {
        ...
        methods: {
          onGeolocationChange (newPosition) {
            this.geolocationPosition = newPosition
            if (newPosition) {
              this.features[0].setGeometry(new ol.geom.Point(newPosition))
