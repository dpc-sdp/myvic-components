...
import { YourVicDataBlock as DataBlock } from '@dpc-sdp/yourvic-data-block'
...
<Preview>
  <Story name="Popups">
    {
      {
        components: { YourvicMapCore, YourvicMapVectorTileLayer },
        template: `<yourvic-map-core
          :containerStyle="containerStyle"
          :center="center"
          :zoom="11"
...
<Preview>
  <Story name="Select Interaction">
    {
      {
        components: { YourvicMapCore, YourvicMapVectorLayer },
        template: `<yourvic-map-core
          :containerStyle="containerStyle"
          :center="center"
          :zoom="1"
...
<Preview>
  <Story name="Events">
    {
      {
        components: { YourvicMapCore, YourvicMapVectorLayer, RplContainer, RplRow, RplCol, DataBlock },
        template: `
          <RplContainer style="width: 100%">
            <rpl-row>
              <rpl-col cols=6>
              ...
              <rpl-col cols=6>
                <data-block :data="selectDataBlock" :selectable="false" :isBlock="true" />
                <data-block :data="clickDataBlock" :selectable="false" :isBlock="true" />
              </rpl-col>
            </rpl-row>
          </RplContainer>
        `,
