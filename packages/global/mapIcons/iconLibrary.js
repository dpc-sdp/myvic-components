...
export const icons = {
  ...
  carPin: `<g filter="url(#filter_car)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 30.5C8.5 47.0375 31 68 31 68C31 68 53.5 47.0375 53.5 30.5C53.5 18.3095 43.4393 8 31 8C18.5607 8 8.5 18.3095 8.5 30.5Z" fill="#023B89"/>
  ...
  carPinLarge: `<g filter="url(#filter_carL)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 40.5C12.5 61.4475 41 88 41 88C41 88 69.5 61.4475 69.5 40.5C69.5 25.0587 56.7564 12 41 12C25.2436 12 12.5 25.0587 12.5 40.5Z" fill="#023B89"/>
  ...
  exclamationPin: `<g filter="url(#filter_exc)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 30.5C8.5 47.0375 31 68 31 68C31 68 53.5 47.0375 53.5 30.5C53.5 18.3095 43.4393 8 31 8C18.5607 8 8.5 18.3095 8.5 30.5Z" fill="#CA4C21"/>
  ...
  exclamationPinLarge: `<g filter="url(#filter_excL)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 40.5C12.5 61.4475 41 88 41 88C41 88 69.5 61.4475 69.5 40.5C69.5 25.0587 56.7564 12 41 12C25.2436 12 12.5 25.0587 12.5 40.5Z" fill="#CA4C21"/>
  ...
  pedestrianPin: `<g filter="url(#filter_ped)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M8 30.5C8 47.0375 30.5 68 30.5 68C30.5 68 53 47.0375 53 30.5C53 18.3095 42.9393 8 30.5 8C18.0607 8 8 18.3095 8 30.5Z" fill="#0052C2"/>
  ...
  pedestrianPinLarge: `<g filter="url(#filter_pedL)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 40.5C12.5 61.4475 41 88 41 88C41 88 69.5 61.4475 69.5 40.5C69.5 25.0587 56.7564 12 41 12C25.2436 12 12.5 25.0587 12.5 40.5Z" fill="#0052C2"/>
