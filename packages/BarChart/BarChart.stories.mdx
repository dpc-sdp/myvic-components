...
import { barChartTemplate, stackedBarChartTemplate, chartData, dualChartData, maxChartData, annotationChartData, annotationChartCustomStyles } from './storiesConstants/storiesConstants.js'
import { annotation1, annotation2 } from './storiesConstants/annotations.js'
    ...
    {
      {
       ...
       template: `
        <div style="width: 800px; height: 400px">
          <bar-chart :title="title" :direction="direction" :data="data" :customDatasetStyles="customDatasetStyles" :annotation="annotation" :scaleLimits="scaleLimits" :showLegend="showLegend" :dataFormat="dataFormat" />
        </div>
      `,
       props: {
        direction: { default: () => 'vertical' },
