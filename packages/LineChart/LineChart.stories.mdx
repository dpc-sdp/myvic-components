    ...
    {
      {
        ...
        template: `
          <div :style="divStyle">
            <line-chart :title="title" :data="data" :customDatasetStyles="customDatasetStyles" :annotation="annotation" :showLegend="showLegend" :dataFormat="dataFormat" :shortDesc="shortDesc" :longDesc="longDesc" />
          </div>
        `,
        props: {
          title: {
